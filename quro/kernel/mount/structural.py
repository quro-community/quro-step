...
The interpretation axis — which *reading* applies — is resolved separately and
just as explicitly (see :mod:`quro.kernel.mount.resolver`); a structural path is
never enough on its own to denote one semantics.
"""
